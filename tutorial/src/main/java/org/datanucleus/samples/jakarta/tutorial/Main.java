...
/**
 * Controlling application for the DataNucleus Tutorial using Jakarta Persistence.
...
public class Main
{
    public static void main(String args[])
    {
        ...
        System.out.println("DataNucleus Tutorial with Jakarta");
        System.out.println("=================================");
        ...
        try
        {
            ...
            hints.put("jakarta.persistence.loadgraph", allGraph);
